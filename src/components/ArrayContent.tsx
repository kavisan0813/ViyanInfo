...
export const Homecontent8 = [
  { count: 3, label: "Products Launched" },
  { count: 6, label: "Enterprise Solutions" },
  { count: 5, label: "Industries Served" },
  { count: 8, label: "Combined Engineering Exp" },
];
...
export const HomecontentProducts = [
  ...
  {
    name: "Viyan Flow",
    tagline: "Automated Integration & Workflow Engine",
    problem:
      "Connects fragmented databases and eliminates operational delays by synchronizing client CRMs with enterprise ERPs via custom real-time WebSockets.",
    who: "SaaS Platforms & Logistics Teams",
    status: "Active Beta",
  ...
  {
    name: "Viyan Insight",
    tagline: "Real-time Business Intelligence Analytics",
    problem:
      "Replaces slow manual report rendering with sub-second database query execution and interactive web dashboard visualizers.",
    who: "Retail Management & Startup Founders",
    status: "Internal Release",
    statusColor: "bg-purple-500/10 text-purple-600 border border-purple-500/20",
    color: "#EC4899",
